...
\href{mailto:n.pavie@avh.asso.fr}{n.pavie@avh.asso.fr}
~
\href{https://github.com/NPavie}{NPavie $\vcenter{\hbox{\includegraphics[width=10pt]{github}}}$}
\href{https://github.com/studio-PAON-AVH}{studio-PAON-AVH $\vcenter{\hbox{\includegraphics[width=10pt]{github}}}$}
\section{Langues}
Français : natif
Anglais : courant
Allemand : scolaire
...
{
\textbf{→ }Conception, suivi et maintenance des chaines de traitements et des logiciels 
de production d'adaptations pour le \emph{Pôle d'Adaptation des Ouvrages Numériques} :
\begin{itemize}
\item Gestion et suivi des développements de l'application de production 
    d'adaptation en ligne \href{https://github.com/studio-PAON-AVH/studio-paon}{Studio-Paon};
\item Conception d'un \href{https://github.com/studio-PAON-AVH/complement-word-braille}{complément 
    Word pour la préparation du braille abrégé};
\item Réalisation de feuilles de transformation XSLT pour la remédiation 
    de fichiers éditeurs à l'aide du moteur Saxon;
\item Conception d'une chaine de production automatisée pour la réintégration 
...
\textbf{→  }Encadrement d'une mission d'apprentissage sur la conception d'un outil 
de description d'images assité par intelligence articielle pour la transcription 
d'EPUBs;\\
\textbf{→  }Réalisation de développements pour le \href{https://daisy.org}{DAISY Consortium} :
\begin{itemize}
\item Maintenance et développement du projet \href{https://github.com/daisy/word-save-as-daisy}{Save As DAISY};
\item Développements de modules pour le projet \href{https://github.com/daisy/pipeline}{DAISY Pipeline 2};
\item Participation aux développements du projet \href{https://github.com/daisy/pipeline-ui}{DAISY Pipeline app}.
\end{itemize}
}
%------------------------------------------------
\entry
...
{
\textbf{→ }Déploiement et administration de services en ligne;\\
\textbf{→ }Gestion et réalisation de projets R\&D logiciels :
\begin{itemize}
\item Conception d'une chaîne de pré-traitement pour améliorer la lisibilité des livres PDFs générés par PrinceXML et à destination des personnes dyslexiques;
\item Participation à la conception de la plateforme de formation en ligne \href{https://github.com/SIDPT/Claroline}{IPIP}.
\end{itemize}
\textbf{→ }Réalisation de développements pour le \href{https://daisy.org}{DAISY Consortium}
\begin{itemize}
\item Maintenance et développement du projet \href{https://github.com/daisy/word-save-as-daisy}{Save As DAISY};
\item Encadrement de stage sur la création de connecteurs pour la synthèse vocale dans le logiciel \href{https://github.com/daisy/pipeline}{DAISY Pipeline 2}.
\end{itemize}
}
%------------------------------------------------
\entry
...
{
\textbf{→ }Administration de l’infrastructure informatique;\\
\textbf{→ }Mise en place d’outils de suivi de la maintenance et des développements;\\
\textbf{→ }Gestion et réalisation de projets R\&D informatique et impression.
...
{\href{http://www.igs-cp.fr/}{IGS-CP}, Angoulême, France}
{
\textbf{→ }Suivi et maintenance des développements de production existants;\\
\textbf{→ }Support matériel et logiciel pour la maintenance informatique;\\
\textbf{→ }Support administrateur pour l’infrastructure informatique;\\
\textbf{→ }Support technique et logiciel pour l’impression;\\
\textbf{→ }Gestion et réalisation de projets R\&D informatique et impression.
...
{
\textbf{Thèmes de recherches} : \emph{les bruits procéduraux pour la synthèse de texture, le rendu temps-réel, le rendu volumétrique basé point sur carte graphique}.\\
\textbf{→ }Participation au développement, à la maintenance et à l’optimisation du moteur de
...
%(batch) et Linux (bash).\\
\textbf{→ }Enseignant pour \href{https://www.sciences.unilim.fr/}{la Faculté des Sciences et Techniques}; \\
...
\textbf{→ }Enseignant pour l'\href{https://www.iut.unilim.fr/}{Institut Universitaire de Technologie} au département Métier du Multimédia et d'Internet.
...
{\textbf{Thèse} : \emph{Génération procédurale de détails naturels pour la synthèse d'image réaliste} \\
...
{\href{http://www.unilim.fr/}{Université de Limoges}, France}
{\textbf{Sujet d'étude} : \emph{la génération procédurale et le rendu temps réel de champs d'herbes}.}
%------------------------------------------------
\end{entrylist}
