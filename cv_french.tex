...
{\color{red} $\varheartsuit$} GLSL, C/C++/C\#, Python
Java (+ Android)
SQL, PHP, HTML5/CSS3/JS
Perl, XML, XSLT, XPROC
NASM x86
\LaTeX
\section{Systèmes}
...
{
Déploiement et administration de services en ligne : \href{https://mm.braillenet.org}{Mattermost}, \href{https://limesurvey.braillenet.org/}{Limesurvey}, \href{https://sidpt.braillenet.org}{IPIP}\\
...
- Encadrement de stage sur la création de connecteurs pour la synthèse vocale dans le logiciel \href{https://github.com/NPavie/word-save-as-daisy}{DAISY Pipeline 2},\\
- Développement de l'\emph{addin} Microsoft Word \href{https://github.com/daisy/word-save-as-daisy}{Save As DAISY} pour la conversion de document Word vers les formats DTBook XML, DAISY book et EPUB 3,\\
- Développement de la plateforme d'enseignement en ligne \href{https://github.com/SIDPT/Claroline}{IPIP}, basé sur l'application Claroline Connect, pour la formation à l'édition et la production de livres adaptés aux personnes dys et malvoyantes.
}
%------------------------------------------------
\entry
{2017--2019}
...
rendu temps-réel GobLim du laboratoire XLIM,\\
...
Enseignements pour l'Institut Universitaire de Technologie au département Métier du Multimédia et d'Internet : Algorithmique (java), Traitement de l’image (photoshop / java).
}
%------------------------------------------------
\entry
{Juin 2011}
